...
from GraceMusic import config
from GraceMusic.helpers import Track
...
class Thumbnail:
    def __init__(self):
        try:
            self.title_font = ImageFont.truetype(
                "GraceMusic/helpers/Raleway-Bold.ttf", 32)
            self.regular_font = ImageFont.truetype(
                "GraceMusic/helpers/Inter-Light.ttf", 18)
        except OSError:
    ...
    def _generate_sync(self, temp: str, output: str, song: Track, size=(1280, 720)) -> str:
        ...
        try:
            ...
            icons_path = "GraceMusic/helpers/play_icons.png"
