...
from GraceMusic import tune, app, config, db, lang, logger, queue, tg, yt
from GraceMusic.helpers import admin_check, buttons, can_manage_vc
...
async def _controls(_, query: types.CallbackQuery):
    ...
    try:
        if action in ["skip", "replay", "stop"]:
            ...
            # Auto-delete the reply message after 3 minutes
            if sent_msg:
