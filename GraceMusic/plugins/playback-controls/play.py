...
from GraceMusic import tune, app, config, db, lang, queue, tg, yt
from GraceMusic.helpers import buttons, utils
from GraceMusic.helpers._play import checkUB
import asyncio
import logging
...
async def play_hndlr(
    ...
    if force:
        ...
        if await db.get_call(chat_id):
            ...
            try:
                from GraceMusic import preload
    ...
    try:
        ...
        if "bot" in error_msg.lower() or "sign in" in error_msg.lower():
            await safe_edit(
                ...
                "Solution:\n"
                "• Update YouTube cookies in `GraceMusic/cookies/` folder\n"
