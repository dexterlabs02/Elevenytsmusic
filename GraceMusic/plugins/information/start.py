...
from GraceMusic import app, config, db, lang
from GraceMusic.helpers import buttons, utils
...
async def _help(_, m: types.Message):
    ...
    try:
        ...
        # Fallback to text if photo fails or URL is invalid
        await m.reply_text(
...
async def start(_, message: types.Message):
    ...
    except (errors.ChatSendPhotosForbidden, ValueError, Exception):
        # If photos are not allowed or URL is invalid, send text only
